  ...
  return (
    <div className="min-h-screen bg-[#f7f5f0] text-slate-800 selection:bg-[#2d7d8a] selection:text-white font-['Plus_Jakarta_Sans',sans-serif]">
        ...
        <div className="hidden lg:block bg-[#1e2229] py-2 px-6 text-xs text-stone-300 border-b border-stone-700">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <span className="flex items-center gap-2">
                <Clock className="w-3.5 h-3.5 text-[#2d7d8a]" />
                <span>Mo – Fr: 07:30 – 18:00 Uhr | Sa: 08:00 – 13:00 Uhr</span>
              </span>
            </div>
            <div className="flex items-center gap-4">
              <span className="bg-[#2d7d8a]/20 text-[#c4e3e8] border border-[#2d7d8a]/40 px-2.5 py-0.5 rounded text-[11px] font-bold uppercase tracking-wider">Meisterbetrieb aus Kerpen</span>
              <a href="tel:02237972504" className="font-bold text-white hover:text-[#c4e3e8] transition-colors">☎ 02237 972504</a>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 gap-4">
            ...
            <nav className="hidden lg:flex items-center gap-4 xl:gap-6 justify-center flex-1 mx-2">
              {navLinks.map((l) => (
                <a key={l.href} href={l.href} className="text-[11px] xl:text-xs font-bold uppercase tracking-wider text-slate-700 hover:text-[#2d7d8a] transition-colors whitespace-nowrap px-1 py-1">{l.label}</a>
              ))}
            </nav>
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0 ml-2">
              ...
              <a href="#contact-section" className="hidden sm:inline-flex bg-[#2d7d8a] hover:bg-[#246a75] text-white font-extrabold px-4 sm:px-5 py-2.5 rounded-xl text-xs uppercase tracking-wider shadow-md shadow-[#2d7d8a]/20 transition-all hover:-translate-y-0.5 whitespace-nowrap">
                Angebot Anfragen
              </a>
              {/* Mobile Menu Button */}
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden pb-4 border-t border-stone-300 pt-3 space-y-1 bg-[#f7f5f0]">
              {navLinks.map((l) => (
                <a key={l.href} href={l.href} onClick={() => setMobileMenuOpen(false)} className="block px-4 py-2.5 text-sm font-bold text-slate-800 hover:text-[#2d7d8a] hover:bg-white rounded-lg transition-colors">{l.label}</a>
              ))}
            </div>
          )}
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl space-y-6 sm:space-y-8">
            ...
            <div className="pt-4 border-t border-stone-300 flex flex-wrap items-center gap-6 text-xs text-slate-600 font-semibold">
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#2d7d8a]" /> Festpreis-Garantie</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#2d7d8a]" /> DIN 18534 Abdichtung</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#2d7d8a]" /> Sauberkeits-Versprechen</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              <div key={i} className="p-5 rounded-2xl bg-[#f7f5f0] border border-stone-300 shadow-sm">
                <span className={`font-heading text-2xl sm:text-3xl font-black block ${s.highlight ? 'text-[#2d7d8a]' : 'text-slate-900'}`}>{s.val}</span>
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl overflow-hidden border border-[#2d7d8a]/30 shadow-xl aspect-[4/5] bg-white">
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#2d7d8a] flex items-center justify-center shadow-lg text-white">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4 pt-4">
                <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-stone-300 shadow-sm">
                  <Award className="w-7 h-7 text-[#2d7d8a] shrink-0" />
                  <div>
                ...
                <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-stone-300 shadow-sm">
                  <ShieldCheck className="w-7 h-7 text-[#2d7d8a] shrink-0" />
                  <div>
                ...
                <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-stone-300 shadow-sm">
                  <MapPin className="w-7 h-7 text-[#2d7d8a] shrink-0" />
                  <div>
      ...
      <section id="services" className="py-24 bg-white border-b border-stone-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-[#2d7d8a] font-bold text-xs uppercase tracking-widest block">Unser Leistungsportfolio</span>
            <h2 className="font-heading text-3xl sm:text-5xl uppercase tracking-tight text-slate-900 font-black">
              ...
              <div key={idx} className="craft-card-light rounded-2xl overflow-hidden group flex flex-col sm:flex-row border border-stone-300">
                <div className="relative w-full sm:w-2/5 aspect-[4/3] sm:aspect-auto overflow-hidden bg-stone-200 shrink-0">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="bg-[#2d7d8a] text-white text-[10px] font-extrabold uppercase px-2.5 py-1 rounded-md tracking-wider shadow">{item.badge}</span>
                  </div>
                </div>
                <div className="p-6 flex flex-col justify-between space-y-4 flex-1">
                  <div className="space-y-2">
                    <h3 className="font-heading text-xl font-bold text-slate-900 group-hover:text-[#2d7d8a] transition-colors">{item.title}</h3>
                    <p className="text-slate-600 text-sm leading-relaxed">{item.desc}</p>
                  </div>
                  <a href="#contact-section" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#2d7d8a] hover:text-[#246a75] transition-colors pt-2">
      ...
      <section id="portfolio" className="py-24 bg-[#f7f5f0] border-b border-stone-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-[#2d7d8a] font-bold text-xs uppercase tracking-widest block">Einblicke in unsere Arbeiten</span>
            <h2 className="font-heading text-3xl sm:text-5xl uppercase tracking-tight text-slate-900 font-black">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {galleryItems.map((item, idx) => (
              <div 
                ...
                className="group relative rounded-2xl overflow-hidden cursor-pointer border border-stone-300 hover:border-[#2d7d8a]/80 transition-all duration-500 shadow-md aspect-[4/3] bg-white"
              >
                <img 
                  src={item.src} 
                  alt={item.title} 
                ...
                <div className="absolute bottom-4 left-4 right-4 space-y-1">
                  <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#c4e3e8] block">{item.category}</span>
                  <h3 className="font-heading text-base font-bold text-white group-hover:text-[#c4e3e8] transition-colors">{item.title}</h3>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="craft-card-light rounded-2xl p-8 space-y-4 border border-stone-300">
                <div className="w-12 h-12 rounded-xl bg-[#2d7d8a]/10 border border-[#2d7d8a]/30 text-[#2d7d8a] flex items-center justify-center">
      ...
      <section id="contact-section" className="py-24 bg-[#f7f5f0] border-b border-stone-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-[#2d7d8a] font-bold text-xs uppercase tracking-widest block">Jetzt unverbindlich anfragen</span>
            <h2 className="font-heading text-3xl sm:text-5xl uppercase tracking-tight text-slate-900 font-black">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-8 bg-[#1e2229] text-white rounded-3xl p-8 shadow-xl">
              <div className="space-y-6 text-sm text-stone-300">
                ...
                <div className="flex items-start gap-4">
                  <MapPin className="w-5 h-5 text-[#2d7d8a] shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <PhoneCall className="w-5 h-5 text-[#2d7d8a] shrink-0 mt-1" />
                  <div>
                    <strong className="text-white block text-sm">Telefon & Mobil:</strong>
                    <a href="tel:02237972504" className="hover:text-[#c4e3e8] font-bold text-[#2d7d8a] block">Festnetz: 02237 972504</a>
                    <a href="tel:01638083965" className="hover:text-[#c4e3e8] font-semibold text-stone-300 block">Mobil: 0163 8083965</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Clock className="w-5 h-5 text-[#2d7d8a] shrink-0 mt-1" />
                  <div>
            ...
            <div className="lg:col-span-6 bg-white border border-stone-300 rounded-3xl p-8 shadow-xl">
              ...
              {formSubmitted ? (
                <div className="p-8 rounded-2xl bg-[#2d7d8a]/10 border border-[#2d7d8a]/40 text-[#2d7d8a] text-center space-y-3">
                  <CheckCircle2 className="w-12 h-12 text-[#2d7d8a] mx-auto" />
                ...
                <form onSubmit={handleInlineSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" required placeholder="z. B. Michael Weber" className="w-full bg-[#f7f5f0] border border-stone-300 rounded-xl p-3.5 text-sm text-slate-900 focus:border-[#2d7d8a] outline-none transition-colors" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">Telefonnummer *</label>
                      <input type="tel" required placeholder="z. B. 02237 123456" className="w-full bg-[#f7f5f0] border border-stone-300 rounded-xl p-3.5 text-sm text-slate-900 focus:border-[#2d7d8a] outline-none transition-colors" />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="email" placeholder="ihre@email.de" className="w-full bg-[#f7f5f0] border border-stone-300 rounded-xl p-3.5 text-sm text-slate-900 focus:border-[#2d7d8a] outline-none transition-colors" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">Projekt-Art</label>
                      <select className="w-full bg-[#f7f5f0] border border-stone-300 rounded-xl p-3.5 text-sm text-slate-800 focus:border-[#2d7d8a] outline-none transition-colors">
                  ...
                  <div>
                    ...
                    <textarea required rows={4} placeholder="Beschreiben Sie kurz Ihr Projekt (z. B. Badsanierung ca. 12 m² mit barrierefreier Dusche in Kerpen)..." className="w-full bg-[#f7f5f0] border border-stone-300 rounded-xl p-3.5 text-sm text-slate-900 focus:border-[#2d7d8a] outline-none transition-colors" />
                  </div>

                  <p className="text-[11px] text-slate-500 leading-relaxed">
                    Mit dem Absenden erklären Sie sich mit der Verarbeitung Ihrer Angaben zur Bearbeitung der Anfrage einverstanden (<button type="button" onClick={() => setIsDatenschutzOpen(true)} className="underline text-slate-700 hover:text-[#2d7d8a]">Datenschutz</button>).
                  </p>

                  <button type="submit" className="w-full bg-[#2d7d8a] hover:bg-[#246a75] text-white font-extrabold py-4 rounded-xl text-xs uppercase tracking-wider shadow-lg shadow-[#2d7d8a]/20 transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2">
      ...
      <section id="faq" className="py-24 bg-white border-b border-stone-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 space-y-4">
            <span className="text-[#2d7d8a] font-bold text-xs uppercase tracking-widest block">Einwandbehandlung & Details</span>
            ...
            {faqs.map((faq, idx) => {
              ...
              return (
                <div key={idx} className="bg-[#f7f5f0] border border-stone-300 rounded-2xl overflow-hidden shadow-sm">
                  <button onClick={() => setOpenFaq(isOpen ? null : idx)} className="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base text-slate-900 hover:text-[#2d7d8a] transition-colors">
                    <span className="flex items-center gap-3"><HelpCircle className="w-5 h-5 text-[#2d7d8a] shrink-0" /><span>{faq.q}</span></span>
                    <ChevronDown className={`w-5 h-5 text-[#2d7d8a] shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
                  </button>
      ...
      <footer className="bg-[#1e2229] pt-16 pb-24 lg:pb-12 text-stone-300 border-t border-stone-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-stone-700">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-[#2d7d8a] text-white flex items-center justify-center shadow-md">
                  <Layers className="w-5 h-5 stroke-[2.5]" />
                </div>
                <span className="font-heading text-lg font-black uppercase text-white tracking-tight">LUDWIG <span className="text-[#2d7d8a]">FONK</span></span>
              </div>
              ...
              <div className="pt-2 flex items-center gap-2 text-[11px] text-[#c4e3e8] font-bold bg-[#2d7d8a]/20 border border-[#2d7d8a]/40 px-3 py-1.5 rounded-lg w-fit">
                <AlertCircle className="w-3.5 h-3.5 text-[#c4e3e8] shrink-0" />
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs">
                <li><a href="#services" className="hover:text-[#2d7d8a] transition-colors">Badsanierung & Duschen</a></li>
                <li><a href="#services" className="hover:text-[#2d7d8a] transition-colors">XXL-Großformatfliesen</a></li>
                <li><a href="#services" className="hover:text-[#2d7d8a] transition-colors">Natursteinverlegung</a></li>
                <li><a href="#services" className="hover:text-[#2d7d8a] transition-colors">Balkone & Terrassen</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-xs">
                <p className="flex items-center gap-2"><MapPin className="w-3.5 h-3.5 text-[#2d7d8a] shrink-0" /><span>Concordiastr. 11, 50169 Kerpen</span></p>
                <p className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 text-[#2d7d8a] shrink-0" /><a href="tel:02237972504" className="hover:text-white font-bold text-[#2d7d8a]">02237 972504</a></p>
                <p className="flex items-start gap-2 pt-1"><Clock className="w-3.5 h-3.5 text-[#2d7d8a] shrink-0 mt-0.5" /><span>Mo–Fr: 07:30–18 Uhr | Sa: 08–13 Uhr</span></p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs">
                <li><button onClick={() => setIsImpressumOpen(true)} className="hover:text-[#2d7d8a] transition-colors">Impressum</button></li>
                <li><button onClick={() => setIsDatenschutzOpen(true)} className="hover:text-[#2d7d8a] transition-colors">Datenschutzerklärung</button></li>
                <li><a href="#contact-section" className="hover:text-[#2d7d8a] transition-colors">Anfahrt & Anfragen</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-stone-400 gap-4">
            ...
            <div className="flex items-center gap-6">
              <button onClick={() => setIsImpressumOpen(true)} className="hover:text-[#2d7d8a] transition-colors">Impressum</button>
              <button onClick={() => setIsDatenschutzOpen(true)} className="hover:text-[#2d7d8a] transition-colors">Datenschutz</button>
            </div>
          </div>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md" onClick={() => setSelectedGalleryImg(null)}>
          <div className="relative max-w-4xl w-full bg-white border border-stone-300 rounded-3xl overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-2">
              <span className="text-xs font-bold uppercase tracking-widest text-[#2d7d8a]">{selectedGalleryImg.category}</span>
